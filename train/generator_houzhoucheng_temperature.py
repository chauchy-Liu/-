...
async def main():
    import importlib
    algName = 'generator_houzhoucheng_temperature'
    ...
    for index, row in df_wind_turbine.iterrows():
        ...
        if os.path.exists(os.path.join('model',config.Wind_Farm, name, assetId, 'generator_houzhoucheng_temperature.model')):
            continue
        ...
        import joblib
        if os.path.exists(os.path.dirname(os.path.join('model',config.Wind_Farm, name, assetId, 'generator_houzhoucheng_temperature.model'))):
            pass
        else:
            os.makedirs(os.path.dirname(os.path.join('model',config.Wind_Farm, name, assetId, 'generator_houzhoucheng_temperature.model')))
        joblib.dump(gs.best_estimator_, os.path.join('model',config.Wind_Farm, name, assetId, 'generator_houzhoucheng_temperature.model'))
